...
AWorldSpawner::AWorldSpawner()
{
	...
	static ConstructorHelpers::FObjectFinder<UBlueprint> ItemBlueprint(TEXT("Blueprint'/Game/Blueprints/BP_Ocivilian.BP_OCivilian'"));
	if (ItemBlueprint.Object) {
		BP_Civilian = (UClass*)ItemBlueprint.Object->GeneratedClass;
	}
}
...
void AWorldSpawner::SpawnCivilians() {
	...
	ACharacter* civilian = GetWorld()->SpawnActor<ACharacter>(BP_Civilian, GetActorLocation(), GetActorRotation(), SpawnParams);
